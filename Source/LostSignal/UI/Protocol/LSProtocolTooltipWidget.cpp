...
{
	// 이름 텍스트는 LSProtocol::GetProtocolDisplayName이 단일 출처다.
	return LSProtocol::GetProtocolDisplayName(ProtocolType);
}
...
FText GetEnableDisplayText(const FName EnableName)
{
	static const TMap<FName, FText> Labels = {
		...
		{ TEXT("HP_Text"), LOCTEXT("HPText", "체력 수치 표시") },
		{ TEXT("Stamina_Text"), LOCTEXT("StaminaText", "스태미나 수치 표시") },
		{ TEXT("HP_Bar"), LOCTEXT("HPBar", "체력 UI 표시") },
		{ TEXT("HP_Preview"), LOCTEXT("HPPreview", "체력 예측 UI 표시") },
		{ TEXT("HP_Overhead"), LOCTEXT("HPOverhead", "머리 위 체력 UI 표시") },
		{ TEXT("Stamina_Overhead"), LOCTEXT("StaminaOverhead", "머리 위 스태미나 UI 표시") },
		{ TEXT("Monster_Sound"), LOCTEXT("MonsterSound", "몬스터 소리 방향 표시") },
		{ TEXT("Monster_State"), LOCTEXT("MonsterState", "몬스터 상태 표시") },
		...
		{ TEXT("Skill_Slot"), LOCTEXT("SkillSlot", "스킬 슬롯 UI 표시") },
		{ TEXT("Projectile_Trajectory"), LOCTEXT("ProjectileTrajectory", "투사체 궤적 UI 표시") },
		{ TEXT("Skill_Range"), LOCTEXT("SkillRange", "스킬 범위 UI 표시") },
		{ TEXT("Skill_Casting_Gauge"), LOCTEXT("SkillCastingGauge", "스킬 캐스팅 게이지바 UI 표시") },
		{ TEXT("Skill_Cooldown"), LOCTEXT("SkillCooldown", "스킬 쿨타임 숫자 UI 표시") },
		{ TEXT("Skill_Cooldown_Gauge"), LOCTEXT("SkillCooldownGauge", "스킬 쿨타임 게이지바 UI 표시") },
